...
var canvas, angle, tower, ground, cannon, boat,brokenboat;
var balls = [];
var boats = [];
...
function preload() {
  ...
  brokenboatSpritedata = loadJSON("assets/broken-ship-01.json");
  brokenboatSpritesheet = loadImage("assets/broken-ship-01.png");
